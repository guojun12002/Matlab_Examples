...
MODEL              = pll_wbsd_2
MODULES            = HostLib_FFT.c HostLib_rtw.c pll_wbsd_2_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE           = pll_wbsd_2.mk
MATLAB_ROOT        = I:\R2012a
ALT_MATLAB_ROOT    = I:\R2012a
MATLAB_BIN         = I:\R2012a\bin
ALT_MATLAB_BIN     = I:\R2012a\bin
MASTER_ANCHOR_DIR  = 
START_DIR          = g:\AMS\pll
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f C:\Users\Dick\AppData\Roaming\MATHWO~1\MATLAB\R2012a\mexopts.bat
COMPUTER           = PCWIN64
VISUAL_VER         = 9.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\shared\dspblks\extern\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\shared\dsp\vision\matlab\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\pll_wbsd_2
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\dsp\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\comm\extern\include
...
{$(MATLAB_ROOT)\toolbox\shared\dspblks\extern\src}.c.obj :
	@echo ### Compiling $<
	$(CC) $(MEX_FLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\comm\extern\src}.c.obj :
	@echo ### Compiling $<
	$(CC) $(MEX_FLAGS) $<

{$(MATLAB_ROOT)\toolbox\comm\extern\include}.c.obj :
	@echo ### Compiling $<
	$(CC) $(MEX_FLAGS) $<



{$(MATLAB_ROOT)\toolbox\shared\dspblks\extern\src}.cpp.obj : 
	@echo ### Compiling $< 
	$(CC) $(MEX_FLAGS) $< 
...
{$(MATLAB_ROOT)\toolbox\comm\extern\src}.cpp.obj : 
	@echo ### Compiling $< 
	$(CC) $(MEX_FLAGS) $< 

{$(MATLAB_ROOT)\toolbox\comm\extern\include}.cpp.obj : 
	@echo ### Compiling $< 
	$(CC) $(MEX_FLAGS) $< 
